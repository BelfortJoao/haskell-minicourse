...
/* package random-test-0.1.0.0 */
#ifndef VERSION_random_test
#define VERSION_random_test "0.1.0.0"
#endif /* VERSION_random_test */
#ifndef MIN_VERSION_random_test
#define MIN_VERSION_random_test(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_random_test */
...
#define CURRENT_COMPONENT_ID "random-test-0.1.0.0-inplace-random-test"
